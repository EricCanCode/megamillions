...
public class MyMegaMillions {
    public static void main(String[] args) {
	int maxLoop = 0;

	// Display a Welcome note
 	System.out.println("Welcome to the Mega Millions Lotto 6 Number Picker");
	...
	// but limit it between 1 and 70
	randInt = randomGen.nextInt(71);
	System.out.println("Number 1: " + randInt);

	// Generate a random Int
	// but limit it between 0 and 70
	randInt = randomGen.nextInt(71);
	...
	// Generate a random Int
	// but limit it between 0 and 25
	randInt = randomGen.nextInt(26);
